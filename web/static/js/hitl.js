...
const HITL_LOGS_PAGE_SIZE_KEY = 'cybermind_hitl_logs_page_size';
const HITL_PENDING_PAGE_SIZE_KEY = 'cybermind_hitl_pending_page_size';
const HITL_TIMEOUT_DEFAULT_MIGRATION_PREFIX = 'cybermind-hitl-timeout-default-v1:';
...
function readHitlLocalStorageConv(conversationId) {
    ...
    try {
        const key = 'cybermind-chat-hitl:' + String(conversationId).trim();
