...
async function loadConfig(loadTools = true, options = {}) {
    ...
    try {
        ...
        if (wechatBotAgent) wechatBotAgent.value = wechat.bot_agent || 'CyberMind-网络空间自主决策引擎/1.0';
        ...
        const config = {
            ...
            robots: {
                ...
                wechat: {
                    ...
                    bot_agent: document.getElementById('robot-wechat-bot-agent')?.value.trim() || 'CyberMind-网络空间自主决策引擎/1.0',
