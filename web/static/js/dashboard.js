...
var DASHBOARD_SEVERITY_STATUS_FILTER_STORAGE_KEY = 'cybermind.dashboard.severityStatusFilter';
...
var dashboardState = {
    ...
    accessTab: 'webshell',      // 接入概览 Tab：webshell
...
async function refreshDashboard() {
    ...
    try {
        ...
        // 接入概览（WebShell）
        renderDashboardAccessOverview(webshellRes);
...
/** 接入概览：WebShell */
function renderDashboardAccessOverview(webshellRes) {
...
/** WebShell 接入概览 Tab 切换（当前仅 WebShell 一项） */
function switchDashboardAccessTab(tab) {
    dashboardState.accessTab = 'webshell';
    applyDashboardAccessTabUI('webshell');
}
