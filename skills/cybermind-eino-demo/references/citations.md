...
1. `GET /api/skills/cybermind-eino-demo` 响应中的 `package_files` 应包含 `references/citations.md`。
2. `GET /api/skills/cybermind-eino-demo?resource_path=references/citations.md` 应返回本文内容。
