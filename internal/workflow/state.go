...
func init() {
	schema.RegisterName[*WorkflowLocalState]("_cybermind_workflow_local_state")
	schema.RegisterName[NodeOutputEnvelope]("_cybermind_workflow_node_output_envelope")
	schema.RegisterName[StartOutput]("_cybermind_workflow_start_output")
	schema.RegisterName[ConditionOutput]("_cybermind_workflow_condition_output")
	schema.RegisterName[ToolOutput]("_cybermind_workflow_tool_output")
	schema.RegisterName[AgentOutput]("_cybermind_workflow_agent_output")
	schema.RegisterName[HITLOutput]("_cybermind_workflow_hitl_output")
	schema.RegisterName[OutputNodeOutput]("_cybermind_workflow_output_node_output")
}
